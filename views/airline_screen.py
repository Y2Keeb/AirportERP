...
class AirlineScreen(BaseWindow):
    def __init__(self, root,username=None, view_manager=None):
        ...
        self.lbl_departure_date = ctk.CTkLabel(self.frame_content, text="Departure date: ")
        self.lbl_arrival_date = ctk.CTkLabel(self.frame_content, text="Arrival date: ")
    ...
    def create_widgets(self):
        ...
        greeting_label.grid(row=0, column=0, pady=10, padx=5, sticky="ew")
        #labels
        self.lbl_airline.grid(row=1, column=0,padx=10, pady=8,sticky="w")
        self.lbl_from_location.grid(row=2,column=0,padx=10,pady=8,sticky="w")
        self.lbl_to_location.grid(row=3,column=0,padx=10,pady=8,sticky="w")
        self.lbl_departure_date.grid(row=4,column=0,padx=10,pady=8,sticky="w")
        self.lbl_arrival_date.grid(row=5,column=0,padx=10,pady=8,sticky="w")
        self.lbl_plane_type.grid(row=6,column=0,padx=10,pady=8,sticky="w")
        self.lbl_total_seats.grid(row=7,column=0,padx=10,pady=8,sticky="w")
        self.lbl_price.grid(row=8,column=0,padx=10,pady=8,sticky="w")
        #entries
        self.airline_entry.grid(row=1, column=1, padx=10,pady=8,sticky="w")
        self.from_location_entry.grid(row=2, column=1, padx=10,pady=8,sticky="w")
        self.to_location_entry.grid(row=3, column=1, padx=10,pady=8,sticky="w")
        self.departure_date_entry.grid(row=4, column=1, padx=10,pady=8,sticky="w")
        self.arrival_date_entry.grid(row=5, column=1, padx=10,pady=8,sticky="w")
        self.plane_type_entry.grid(row=6, column=1, padx=10,pady=8,sticky="w")
        self.total_seat_entry.grid(row=7, column=1, padx=10,pady=8,sticky="w")
        self.price_entry.grid(row=8, column=1, padx=10,pady=8,sticky="w")
